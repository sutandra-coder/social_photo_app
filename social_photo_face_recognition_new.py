...
social_photo_face_recognition_new = Blueprint('social_photo_face_recognition_new_api', __name__)
api = Api(social_photo_face_recognition_new,  title='Social Photo Face Recognition New API',description='Social Photo Face Recognition New')
name_space = api.namespace('SocialPhotoWithFaceRecognitionNew',description='Social Photo')
		...
		def updateProfileImageAsync(**kwargs):
			...
			if user_profile_count > 0:
				...
				for key,user_profile in enumerate(user_profiles):
					...
					profile_image = face_recognition.load_image_file("home/ubuntu/flaskproject/images/"+str(user_profile['user_id'])+"-"+str(user_profile['image_no'])+"-"+name+".jpg")	
						...
						if event_photo_count > 0 :
							...
							for ekey,edata in enumerate(event_photo_list_data):
								...
								try:
									...
									urllib.request.urlretrieve(edata['image'], "home/ubuntu/flaskproject/images/"+unknown_image_name+".jpg")
									...
									known_image = face_recognition.load_image_file("home/ubuntu/flaskproject/images/"+str(user_profile['user_id'])+"-"+str(user_profile['image_no'])+"-"+name+".jpg")
					...
					for upkey,user_profile_image in enumerate(user_profile_images):
						...
						try:
							if(user_profile_image['profile_image'] != ''):
								...
								urllib.request.urlretrieve(user_profile_image['profile_image'], "home/ubuntu/flaskproject/images/"+str(data['user_id'])+"-"+str(user_profile_image['image_no'])+"-"+data['name']+".jpg")		
								#known_image = face_recognition.load_image_file(data['name']+".jpg")
